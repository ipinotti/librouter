...
int do_rmon_add_alarm(int num, char *var_oid, oid *name, size_t namelen, int interval, int var_type, int rising_th, int rising_event, int falling_th, int falling_event, int status, char *owner);
...
int sendtrap(char *snmp_trap_version, char *community_rcv, char *trap_obj_oid, struct trap_data_obj *data);

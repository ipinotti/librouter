...
#define DEFAULT_MIBS "IP-MIB:IF-MIB:TCP-MIB:UDP-MIB:HOST-RESOURCES-MIB:SNMPv2-MIB:RFC1213-MIB:NOTIFICATION-LOG-MIB:SNMP-TARGET-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM"
...
#define LOGFILE "/var/log/snmp.log"
...
/* The assigned enterprise number for the DATACOM MIB modules. */
#define ENTERPRISE_OID 3709
#define ENTERPRISE_MIB 1,3,6,1,4,1,3709
#define ENTERPRISE_DOT_MIB 1.3.6.1.4.1.3709
#define ENTERPRISE_DOT_MIB_LENGTH	7

/* The assigned enterprise number for sysObjectID. */
#define SYSTEM_MIB		1,3,6,1,4,1,3709,3,2,OSTYPE
#define SYSTEM_DOT_MIB		1.3.6.1.4.1.3709.3.2.OSTYPE
#define SYSTEM_DOT_MIB_LENGTH	10

/* The assigned enterprise number for notifications. */
#define NOTIFICATION_MIB 3709
#define NOTIFICATION_DOT_MIB 3709
#define NOTIFICATION_DOT_MIB_LENGTH 1
...
#define CONFIGURE_OPTIONS "\"'--build=i686-mandrake-linux-gnu' '--host=ppc-32-linux-gnu' '--sysconfdir=/etc' '--with-persistent-directory=/var/netsnmp' '--with-endianness=big' '--with-transports=UDP TCP' '--with-out-transports=UDPIPv6 TCPIPv6 IPX ALL5PVC' '--with-mib-modules=satrouter mibII' '--with-out-mib-modules=snmpv3mibs ucd_snmp agent_mibs agentx' '--with-default-snmp-version=2' '--with-sys-contact= ' '--with-sys-location= ' '--with-logfile=/var/log/snmp.log' '--with-persistent-directory=/var/net-snmp' '--with-enterprise-oid=3709' '--with-enterprise-notification-oid=3709' '--with-cc=powerpc-linux-gnu-gcc' '--with-ar=powerpc-linux-gnu-ar' '--with-libs=-lconfig' '--with-pic' '--without-openssl' '--enable-shared' '--enable-internal-md5' '--disable-static' '--disable-manuals' '--disable-scripts' '--disable-mibs' '--disable-mib-loading' '--disable-debugging' 'CC=powerpc-linux-gnu-gcc' 'CFLAGS=-O2 -Wall -D_SOFT_FLOAT -Dlinux -I/opt/freescale/powerpc-linux-gnu/berlin/include' 'CPPFLAGS=' 'LDFLAGS=-L/opt/freescale/powerpc-linux-gnu/berlin/lib' 'build_alias=i686-mandrake-linux-gnu' 'host_alias=ppc-32-linux-gnu'\""

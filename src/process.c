 ...
 *
 * @param progname	nome do processo
 * @param arg 		se diferente de NULL restringe a busca a processos que
 *		  contenham a string 'arg' na sua linha de comando
 * @param proc_cmdline	buffer onde sera armazenado a linha de comando completa
